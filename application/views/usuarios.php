 ...
 <!--Main layout-->
    <main>
        ...
        <section class="mt-2">
            <h3 class="text-center">Agregar Usuarios</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <h6 class="ml-4 mt-5 dark-grey-text font-weight-bold"><i class="fa fa-long-arrow-up blue-text mr-3" aria-hidden="true"></i> 2000</h6>
                            <!--/.Card Data-->
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        ...
                        <div class="card">
                            ...
                            <h6 class="ml-4 mt-5 dark-grey-text font-weight-bold"><i class="fa fa-long-arrow-down red-text mr-3" aria-hidden="true"></i> $ 2000</h6>
                            <!--/.Card Data-->
